...
const renderTopBooks = (topBooks, object) => {
  ...
  <div class="gallery-and-genre-type">
     ...
     ${item.books
       .map(book => {
         return ` <div class="card" id=${book._id}><div class="wrapper"><img src="${book.book_image}" class="book-cover" loading="lazy"><div class="overlay-box">
  ...
  getBooksByCategory(category).then(result => {
    ...
    object.insertAdjacentHTML(
      ...
      `<div class="gallery-select">${result.data
        .map(element => {
          return `<div class="card" id=${element._id}><div class="wrapper"><img src="${element.book_image}" class="book-cover" loading="lazy"><div class="overlay-box">
          <p class="overlay-text">
            Quick view
          </p>
